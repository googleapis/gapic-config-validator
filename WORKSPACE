...
http_archive(
    ...
    urls = [
        "https://github.com/bazelbuild/rules_go/archive/v0.30.0.zip",
    ],
    strip_prefix = "rules_go-0.30.0",
    sha256 = "9ec63ff0639debae1dac939cf5a1bbd406d2c0af0d7cce6feb0662b4ddeb03c0",
)
